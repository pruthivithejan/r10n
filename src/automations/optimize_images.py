...
class ImageOptimizer:
        ...
        try:
            ...
            with Image.open(input_path) as img:
                ...
                while current_quality >= 10:
                    ...
                    current_quality -= 5
                    print(f"  🔄 Reducing quality to {current_quality}% (size: {new_size_mb:.2f}MB)")
                ...
                print(f"  📊 Size: {original_size_mb:.2f}MB → {final_size_mb:.2f}MB ({result['compression_ratio']:.1f}% reduction)")
    ...
    def process_directory(self) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"🎯 Target: WebP format, max {self.config.max_size_mb}MB, quality {self.config.quality}%")
            print()
    ...
    def print_summary(self):
        ...
        if self.results["processed"] > 0:
            ...
            print(f"💾 Total saved: {total_reduction:.2f}MB ({reduction_percentage:.1f}% reduction)")
